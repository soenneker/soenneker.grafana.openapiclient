...
using Soenneker.Grafana.OpenApiClient.Admin.Users.Item;
...
using System;
namespace Soenneker.Grafana.OpenApiClient.Admin.Users
{
    /// <summary>
    ...
    public partial class UsersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.UsersRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserResponse?> PostAsync(global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserForm body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserResponse> PostAsync(global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserForm body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserResponse>(requestInfo, global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// If you are running Grafana Enterprise and have Fine-grained access control enabled, you need to have a permission with action `users:create`.Note that OrgId is an optional parameter that can be used to assign a new user to a different organization when `auto_assign_org` is set to `true`.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserForm body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Grafana.OpenApiClient.Models.AdminCreateUserForm body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.UsersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Grafana.OpenApiClient.Admin.Users.UsersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Grafana.OpenApiClient.Admin.Users.UsersRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
