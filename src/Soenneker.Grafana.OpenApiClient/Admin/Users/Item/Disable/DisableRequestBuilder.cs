...
{
    /// <summary>
    /// Builds and executes requests for operations under \admin\users\{userId}\disable
    /// </summary>
    ...
    public partial class DisableRequestBuilder : BaseRequestBuilder
    {
        ...
        public DisableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/disable", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.Disable.DisableRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DisableRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/disable", rawUrl)
        {
        }
        /// <summary>
