...
{
    /// <summary>
    /// Builds and executes requests for operations under \admin\users\{userId}\quotas
    /// </summary>
    ...
    public partial class QuotasRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.Quotas.Item.WithQuotaTargetItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("quotaTarget", position);
                return new global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.Quotas.Item.WithQuotaTargetItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        ...
        public QuotasRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/quotas", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.Quotas.QuotasRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QuotasRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/quotas", rawUrl)
        {
        }
        /// <summary>
