...
{
    /// <summary>
    /// Builds and executes requests for operations under \admin\users\{userId}\revoke-auth-token
    /// </summary>
    ...
    public partial class RevokeAuthTokenRequestBuilder : BaseRequestBuilder
    {
        ...
        public RevokeAuthTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/revoke-auth-token", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.RevokeAuthToken.RevokeAuthTokenRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RevokeAuthTokenRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/revoke-auth-token", rawUrl)
        {
        }
        /// <summary>
