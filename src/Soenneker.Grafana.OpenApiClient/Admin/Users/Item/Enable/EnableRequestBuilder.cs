...
{
    /// <summary>
    /// Builds and executes requests for operations under \admin\users\{userId}\enable
    /// </summary>
    ...
    public partial class EnableRequestBuilder : BaseRequestBuilder
    {
        ...
        public EnableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/enable", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.Enable.EnableRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EnableRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/enable", rawUrl)
        {
        }
        /// <summary>
