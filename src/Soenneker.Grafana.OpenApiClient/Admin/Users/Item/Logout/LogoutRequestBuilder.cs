...
{
    /// <summary>
    /// Builds and executes requests for operations under \admin\users\{userId}\logout
    /// </summary>
    ...
    public partial class LogoutRequestBuilder : BaseRequestBuilder
    {
        ...
        public LogoutRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/logout", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Admin.Users.Item.Logout.LogoutRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LogoutRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/admin/users/{userId}/logout", rawUrl)
        {
        }
        /// <summary>
