...
using Soenneker.Grafana.OpenApiClient.V1.Provisioning.Templates.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Grafana.OpenApiClient.V1.Provisioning.Templates
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\provisioning\templates
    /// </summary>
    ...
    public partial class TemplatesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Grafana.OpenApiClient.V1.Provisioning.Templates.Item.WithNameItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.Grafana.OpenApiClient.V1.Provisioning.Templates.Item.WithNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.V1.Provisioning.Templates.TemplatesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TemplatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/provisioning/templates", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.V1.Provisioning.Templates.TemplatesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TemplatesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/provisioning/templates", rawUrl)
        {
        }
        /// <summary>
        /// Get all notification template groups.
        /// </summary>
        /// <returns>A List&lt;global::Soenneker.Grafana.OpenApiClient.Models.NotificationTemplate&gt;</returns>
...
#nullable restore
        ...
        public async Task<List<global::Soenneker.Grafana.OpenApiClient.Models.NotificationTemplate>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Grafana.OpenApiClient.Models.NotificationTemplate>(requestInfo, global::Soenneker.Grafana.OpenApiClient.Models.NotificationTemplate.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
