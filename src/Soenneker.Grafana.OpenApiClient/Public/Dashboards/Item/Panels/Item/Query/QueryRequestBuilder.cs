...
using System;
namespace Soenneker.Grafana.OpenApiClient.Public.Dashboards.Item.Panels.Item.Query
{
    /// <summary>
    /// Builds and executes requests for operations under \public\dashboards\{accessToken}\panels\{panelId}\query
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class QueryRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Public.Dashboards.Item.Panels.Item.Query.QueryRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QueryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/public/dashboards/{accessToken}/panels/{panelId}/query", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Public.Dashboards.Item.Panels.Item.Query.QueryRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QueryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/public/dashboards/{accessToken}/panels/{panelId}/query", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Grafana.OpenApiClient.Public.Dashboards.Item.Panels.Item.Query.QueryRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Grafana.OpenApiClient.Public.Dashboards.Item.Panels.Item.Query.QueryRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Grafana.OpenApiClient.Public.Dashboards.Item.Panels.Item.Query.QueryRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
