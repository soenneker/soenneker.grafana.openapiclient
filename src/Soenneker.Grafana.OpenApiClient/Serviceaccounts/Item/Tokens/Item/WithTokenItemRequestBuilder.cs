...
using System;
namespace Soenneker.Grafana.OpenApiClient.Serviceaccounts.Item.Tokens.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \serviceaccounts\{serviceAccountId}\tokens\{tokenId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithTokenItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Serviceaccounts.Item.Tokens.Item.WithTokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTokenItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/serviceaccounts/{serviceAccountId}/tokens/{tokenId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Grafana.OpenApiClient.Serviceaccounts.Item.Tokens.Item.WithTokenItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTokenItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/serviceaccounts/{serviceAccountId}/tokens/{tokenId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Grafana.OpenApiClient.Serviceaccounts.Item.Tokens.Item.WithTokenItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Grafana.OpenApiClient.Serviceaccounts.Item.Tokens.Item.WithTokenItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
